package com.futuristicdevelopers.shamoon.views.custom.video_player;
...
public class EasyVideoPlayer extends FrameLayout
                ...
                .setListener(
                        new AnimatorListenerAdapter() {
                            ...
                            public void onAnimationEnd(Animator animation) {
                                if (mAutoFullscreen) setFullscreen(true);
                            }
                        })
                .start();
    }
    ...
    private void invalidateThemeColors() {
        final int labelColor = Util.isColorDark(mThemeColor) ? Color.WHITE : Color.WHITE;
